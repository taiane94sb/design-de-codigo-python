...
class Calculator2:
    def __init__(self, driverHandler: DriverHandlerInterface) -> None:
        self.__driverHandler = driverHandler
    ...
    def __process_data(self, input_data: List[float]) -> float:
        ...
        result = self.__driverHandler.standard_derivation(first_process_result)
        return 1/result
